...
class _SignPage extends State<SignPage> {
  ...
  String _databaseURL = 'https://modu-tour-default-rtdb.firebaseio.com/';
            ...
            children: <Widget>[
              SizedBox(
                ...
                child: TextField(
                  ...
                  maxLines: 1,
                  decoration: InputDecoration(hintText: '4자 이상 입력해주세요', labelText: '아이디', border: OutlineInputBorder()),
                ),
              ),
              SizedBox(
                height: 20,
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  maxLines: 1,
                  decoration:
                      InputDecoration(hintText: '6자 이상 입력해주세요', labelText: '비밀번호', border: OutlineInputBorder()),
                ),
              ),
              SizedBox(
                height: 20,
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  obscureText: true,
                  maxLines: 1,
                  decoration: InputDecoration(labelText: '비밀번호확인', border: OutlineInputBorder()),
                ),
              ),
              SizedBox(
                height: 20,
                  ...
                  if (_idTextController.value.text.length >= 4 && _pwTextController.value.text.length >= 6) {
                    if (_pwTextController.value.text == _pwCheckTextController.value.text) {
                      ...
                      reference
                          ...
                          .push()
                          .set(User(_idTextController.value.text, digest.toString(), DateTime.now().toIso8601String())
                              .toJson())
                          .then((_) {
