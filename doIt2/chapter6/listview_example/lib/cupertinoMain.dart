...
class _CupertinoMain extends State<CupertinoMain> {
  ...
  Widget build(BuildContext context) {
    //debugPrint("_CupertinoMain build");
    return CupertinoApp(
      home: CupertinoTabScaffold(
          ...
          tabBuilder: (context, value) {
            ...
            if (value == 0) {
              ...
              //CupertinoApp() widget내부에 Material widget(FirstApp)을 포함 하면 여러가지가 기능들이 적용 안됨
              //return FirstApp(list: animalList);
            } else {
              return CupertinoSecondPage(animalList: animalList);
              //CupertinoApp() widget내부에 Material widget(SecondApp)을 포함 하면 여러가지가 기능들이 적용 안됨
              //return SecondApp(list: animalList);
            }
          }),
    );
  }
